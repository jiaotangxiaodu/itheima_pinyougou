...
app.service('typeTemplateService', function ($http) {
    ...
    this.findOptions = function () {
        return $http.get("../typeTemplate/findOptions.do")
    }
    this.findSpecListById = function (typeTemplateId) {
        return $http.get("../typeTemplate/findSpecListById.do?typeTemplateId="+typeTemplateId);
    }
});
