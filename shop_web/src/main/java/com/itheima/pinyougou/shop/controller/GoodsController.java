...
public class GoodsController {
    ...
    @RequestMapping("getCategroyOptionsByParentId")
    public List<Map<String,Object>> getCategroyOptionsByParentId(@RequestParam("parentId") Long parentId){
        List<Map<String,Object>> cats = itemCatService.getCategroyOptionsByParentId(parentId);
        return cats;
    }
