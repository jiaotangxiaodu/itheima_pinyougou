...
import com.itheima.pinyougou.mapper.TbSellerMapper;
import com.itheima.pinyougou.pojo.TbSeller;
import com.itheima.pinyougou.pojo.TbSellerExample;
import com.itheima.pinyougou.pojo.TbSellerExample.Criteria;
...
public class SellerServiceImpl implements SellerService {
    ...
    public void updateStatus(String sellerId, String status) {
        ...
        if(tbSeller == null){
            throw new RuntimeException("数据库中未找到对应的条目,sellerId=" + sellerId);
        }
